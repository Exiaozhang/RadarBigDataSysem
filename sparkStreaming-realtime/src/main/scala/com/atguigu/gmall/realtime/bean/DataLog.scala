...
case class RcsfDataConfig( //RCS数据名称
                     var rcs_name: String,
                     //雷达型号，频段，极化方式
...
case class DirectionData(var DirectionName: String,

                         var Angle: List[Float],

                         var Level: List[Float],

                         var Phase: List[Float]
                        ) {

}

case class TransData(var TrnasName: String,

                     var Azt: List[Float],

                     var AzimuthAngle: List[Float],

                     var AngleOfPitch: List[Float],

                     var LevelValue: List[Float]
                    ) {
